import{a as w,A as z,S as g,b as U,P as H,N as J,K as Q}from"./assets/vendor-N3sEl8X9.js";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))n(r);new MutationObserver(r=>{for(const i of r)if(i.type==="childList")for(const a of i.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&n(a)}).observe(document,{childList:!0,subtree:!0});function o(r){const i={};return r.integrity&&(i.integrity=r.integrity),r.referrerPolicy&&(i.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?i.credentials="include":r.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(r){if(r.ep)return;r.ep=!0;const i=o(r);fetch(r.href,i)}})();const t={cursor:document.querySelector(".cursor"),customCursor:document.querySelector(".custom-cursor"),navLogo:document.querySelector(".nav-logo"),footerLogo:document.querySelector(".footer__logo"),mobileMenu:document.querySelector(".mobile-menu"),menuBtnOpen:document.querySelector(".menu-btn-open"),menuBtnClose:document.querySelector(".menu-btn-close"),menuLinks:document.querySelectorAll(".mob-menu-link, .mob-menu-button"),orderForm:document.querySelector(".order-form"),orderOverlay:document.querySelector(".order-overlay"),petModalOverlay:document.querySelector(".pet-modal-overlay"),scrollToTopBtn:document.querySelector("[data-scroll-top]"),storiesLoadingEl:document.getElementById("stories-loading"),storiesSliderWrap:document.getElementById("stories-slider-wrap"),storiesSwiperEl:document.getElementById("stories-swiper"),storiesWrapperEl:document.getElementById("stories-swiper-wrapper"),storiesPaginationEl:document.getElementById("stories-pagination"),storiesBtnPrev:document.getElementById("stories-btn-prev"),storiesBtnNext:document.getElementById("stories-btn-next"),categoriesList:document.querySelector(".categories-list"),petList:document.querySelector(".pet-list"),petListLoadMoreBtn:document.querySelector(".load-more-pets-btn"),petListLoadMoreBtnWrapper:document.querySelector(".load-more-pets-btn-wrapper"),globalLoader:document.getElementById("global-loader"),devTeamBtn:document.querySelector(".dev-team-btn"),devTeamModalOverlay:document.querySelector(".dev-team-modal-overlay")};let p=0;function y(e){return!(e!=null&&e.skipGlobalLoader)}function S(){t.globalLoader&&(t.globalLoader.classList.remove("is-hidden"),document.body.style.overflow="hidden")}function b(){t.globalLoader&&(p>0||(t.globalLoader.classList.add("is-hidden"),document.body.style.overflow=""))}document.addEventListener("DOMContentLoaded",()=>{S()});window.addEventListener("load",()=>{setTimeout(()=>{b()},600)});const Z=window.fetch;window.fetch=async(...e)=>{p++,S();try{return await Z(...e)}finally{p--,setTimeout(()=>{b()},200)}};w.interceptors.request.use(e=>(y(e)&&(p++,S()),e));w.interceptors.response.use(e=>(y(e.config)&&(p--,setTimeout(()=>{b()},200)),e),e=>(y(e.config)&&(p--,setTimeout(()=>{b()},200)),Promise.reject(e)));const ee=w.create;w.create=function(...e){const s=ee.apply(this,e);return s.interceptors.request.use(o=>(y(o)&&(p++,S()),o)),s.interceptors.response.use(o=>(y(o.config)&&(p--,setTimeout(()=>{b()},200)),o),o=>(y(o.config)&&(p--,setTimeout(()=>{b()},200)),Promise.reject(o))),s};new z("#faq-accordion",{duration:300,showMultiple:!1});const N=()=>t.mobileMenu.classList.toggle("is-open"),I=()=>document.body.classList.toggle("is-scroll-disabled"),te=()=>{N(),I()};t.menuBtnOpen.addEventListener("click",N);t.menuBtnClose.addEventListener("click",N);t.menuBtnOpen.addEventListener("click",I);t.menuBtnClose.addEventListener("click",I);t.menuLinks.forEach(e=>{e.addEventListener("click",te)});const k=w.create({baseURL:"https://paw-hut.b.goit.study/api"}),se="/categories",oe="/animals",re="/orders",ne="/feedbacks";async function ie(){const{data:e}=await k.get(se);return e}async function ae(e=null,s=1,o=9){const n={page:s,limit:o};e&&(n.categoryId=e);const{data:r}=await k.get(oe,{params:n,skipGlobalLoader:!0});return r}const le=async e=>{const{data:s}=await k.post(re,e);return s},q=async(e=1,s=12)=>{const{data:o}=await k.get(ne,{params:{page:e,limit:s},skipGlobalLoader:!0});return o},l={PETS_END:"Це всі хвостики за цим фільтром 🐾",PETS_EMPTY:"Хвостиків у цій категорії ще немає. Спробуйте іншу.",PETS_LOAD_FAIL:"Не вдалося завантажити хвостиків. Спробуйте ще раз.",LOAD_FAIL:"Не вдалося завантажити детальну інформацію про тварину.",PETS_CATEGORY_LOAD_FAIL:"Не вдалося завантажити категорії хвостиків. Перезавантажте сайт та спробуйте ще раз.",NO_FEEDBACKS:"Поки що немає відгуків.",NO_MORE_FEEDBACKS:"Більше відгуків немає.",ORDER_SUCCESS_TITLE:"Заявку успішно надіслано!",ORDER_SUCCESS_TEXT:"Ми зв’яжемося з вами найближчим часом.",ORDER_ERROR:"Не вдалося надіслати заявку. Щось пішло не так. Спробуйте ще раз або пізніше.",NETWORK:"Немає з’єднання з інтернетом.",PET_DETAILS_FAIL:"Не вдалося завантажити дані хвостика. Спробуйте ще раз.",UNKNOWN_ERROR:"Щось пішло не так. Перезавантажте сайт та спробуйте ще раз."};function M(e,s){g.close(),g.fire({toast:!0,position:"top-end",icon:e,title:s,showConfirmButton:!1,timer:3e3,timerProgressBar:!0,background:"var(--color-mariner-lightest)",color:"var(--color-scheme-1-text)",width:"420px",padding:"18px 20px",customClass:{popup:"swal2-toast"},didOpen:o=>{o.style.borderRadius="16px",o.style.border="1px solid var(--color-scheme-1-border)",o.style.fontFamily="var(--font-family)",o.style.boxShadow="0 10px 30px var(--opacity-neutral-darkest-15)",o.style.lineHeight="1.4",o.style.fontSize="15px",o.addEventListener("mouseenter",g.stopTimer),o.addEventListener("mouseleave",g.resumeTimer)}})}const m={success(e){M("success",e)},failure(e){M("error",e)},warning(e){M("warning",e)},info(e){M("info",e)}};document.addEventListener("DOMContentLoaded",()=>{var r;const e=(r=t.orderForm)==null?void 0:r.querySelector('button[type="submit"]');let s=null;window.openOrderModal=function(i){if(!i){console.warn("Спроба відкрити форму без ID тварини");return}s=i,t.orderOverlay.classList.add("is-open"),document.body.classList.add("modal-open"),document.addEventListener("keydown",n)};function o(){t.orderOverlay.classList.remove("is-open"),document.body.classList.remove("modal-open"),document.removeEventListener("keydown",n),setTimeout(()=>{s=null,t.orderForm&&(t.orderForm.reset(),t.orderForm.classList.remove("was-validated"))},250)}function n(i){i.key==="Escape"&&o()}t.orderOverlay.addEventListener("click",i=>{(i.target.closest(".close-btn")||i.target===t.orderOverlay)&&o()}),t.orderForm&&t.orderForm.addEventListener("submit",async i=>{var L,d;if(i.preventDefault(),t.orderForm.classList.add("was-validated"),!t.orderForm.checkValidity())return;const a=new FormData(t.orderForm),u=Object.fromEntries(a.entries()),v={name:u.name.trim(),phone:u.phone.trim(),comment:u.comment?u.comment.trim():"Хочу стати другом",animalId:s};try{e&&(e.disabled=!0,e.textContent="Надсилаємо..."),await le(v),await g.fire({title:l.ORDER_SUCCESS_TITLE,text:l.ORDER_SUCCESS_TEXT,icon:"success",confirmButtonColor:"#2e2f42"}),o()}catch(c){const T=((d=(L=c.response)==null?void 0:L.data)==null?void 0:d.message)||l.ORDER_ERROR;g.fire({title:"Помилка!",text:T,icon:"error"})}finally{e&&(e.disabled=!1,e.textContent="Надіслати")}})});document.addEventListener("mousemove",e=>{t.cursor.style.left=e.clientX+"px",t.cursor.style.top=e.clientY+"px"});t.navLogo.addEventListener("mouseenter",()=>{t.cursor.classList.add("beating","small"),t.cursor.classList.remove("large"),t.cursor.style.transform="translate(-50%, -50%) scale(1)"});t.navLogo.addEventListener("mouseleave",()=>{t.cursor.classList.remove("beating","small"),t.cursor.style.transform="translate(-50%, -50%) scale(0)"});t.footerLogo.addEventListener("mouseenter",()=>{t.cursor.classList.add("beating","large"),t.cursor.classList.remove("small"),t.cursor.style.transform="translate(-50%, -50%) scale(1)"});t.footerLogo.addEventListener("mouseleave",()=>{t.cursor.classList.remove("beating","large"),t.cursor.style.transform="translate(-50%, -50%) scale(0)"});let h=1,O=null,E=!1,f=[],C=V();function de(e){return f.find(s=>String(s._id||s.id)===String(e))}function ce(e,s){return Array.from(new Map([...e,...s].map(o=>[String(o._id||o.id),o])).values())}function R(){t.petList.innerHTML="",h=1,O=null,f=[],t.petListLoadMoreBtn.classList.add("is-hidden"),t.petListLoadMoreBtnWrapper.classList.add("is-hidden")}function ue(){return t.petList.querySelectorAll(".pet-list-item").length>0}function me(e){t.petListLoadMoreBtnWrapper&&(e?t.petListLoadMoreBtnWrapper.classList.remove("is-hidden"):t.petListLoadMoreBtnWrapper.classList.add("is-hidden"))}const pe=()=>{const e=window.innerWidth;return e>=768&&e<1440};function V(){const e=window.innerWidth;return e<768?"mobile":e<1440?"tablet":"desktop"}const fe=()=>{const e=window.innerWidth;return e>=768&&e<1440?8:9};function ve(){return`
  ...
  `}function x(){const e=t.petList.querySelector(".pet-list-loader");e&&e.remove()}function Le(e){return e.map(({_id:s,name:o,age:n,gender:r,image:i,species:a,categories:u,behavior:v})=>`
  ...
  `).join("")}function j(e){const o=pe()&&e&&f.length%2!==0?f.slice(0,-1):f;t.petList.innerHTML=Le(o)}function ge(){if(!f.length||E)return;const e=V();if(e===C)return;C=e;const s=!t.petListLoadMoreBtn.classList.contains("is-hidden");j(s)}async function _(e=null,s=!1){if(!E){s&&(h=1,O=e,t.petList.innerHTML="",f=[],t.petListLoadMoreBtnWrapper&&t.petListLoadMoreBtnWrapper.classList.add("is-hidden")),t.petList.insertAdjacentHTML("beforeend",ve()),E=!0;try{const o=fe(),{animals:n,totalItems:r}=await ae(O,h,o);if(!Array.isArray(n)||n.length===0){R(),m.failure(l.PETS_EMPTY);return}f=ce(f,n);const i=Math.ceil(r/o),a=h<i;x(),j(a),!a||n.length===0?t.petListLoadMoreBtn&&t.petListLoadMoreBtn.classList.add("is-hidden"):t.petListLoadMoreBtn&&t.petListLoadMoreBtn.classList.remove("is-hidden")}catch(o){if(!o.response){m.failure(l.NETWORK);return}m.failure(l.UNKNOWN_ERROR),x(),t.petListLoadMoreBtn&&t.petListLoadMoreBtn.classList.add("is-hidden")}finally{E=!1,me(ue())}}}t.petListLoadMoreBtn&&t.petListLoadMoreBtn.addEventListener("click",async()=>{if(E)return;h+=1,await _(O);const e=t.petList.querySelector(".pet-list-item");if(e){const{height:s}=e.getBoundingClientRect();window.scrollBy({top:s,behavior:"smooth"})}});window.addEventListener("resize",ge);ie().then(e=>{if(!Array.isArray(e)||e.length===0){R(),m.failure(l.PETS_CATEGORY_LOAD_FAIL);return}const s=e.map(({_id:o,name:n})=>`<li class="categories-list-item" data-category-id="${o}">${n}</li>`);t.categoriesList.innerHTML='<li class="categories-list-item active" data-category-id="">Всі</li>'+s.join(""),_()}).catch(e=>{if(R(),!e.response){m.failure(l.NETWORK);return}m.failure(l.UNKNOWN_ERROR)});t.categoriesList.addEventListener("click",e=>{const s=e.target;if(s.nodeName!=="LI"||s.classList.contains("active"))return;const o=t.categoriesList.querySelector(".active");o&&o.classList.remove("active"),s.classList.add("active");const n=s.dataset.categoryId||null;_(n,!0)});const $="/pawsome-stay/assets/icons-AswN4jwa.svg";function ye(e){const o={Dogs:"Собака",Cats:"Кіт",Rabbits:"Кролик",Birds:"Птах",Other:"Тварина"}[e.species]||e.species||"Тварина",n=e._id||e.id;return`
    <div class="pet-modal">
  ...
  `}function be(e){const s=de(e);s?(t.petModalOverlay.innerHTML=ye(s),he()):m.failure(l.LOAD_FAIL)}function he(){t.petModalOverlay.classList.add("is-open"),document.body.classList.add("modal-open"),document.addEventListener("keydown",G)}function P(){t.petModalOverlay.classList.remove("is-open"),document.body.classList.remove("modal-open"),document.removeEventListener("keydown",G),setTimeout(()=>{t.petModalOverlay.innerHTML=""},300)}function G(e){e.key==="Escape"&&P()}document.addEventListener("click",e=>{const s=e.target,o=s.closest(".pet-more-info");if(o){const r=o.closest(".pet-list-item");r!=null&&r.id&&be(r.id);return}if(s.closest(".pet-modal-close")||s===t.petModalOverlay){P();return}const n=s.closest("#petModalActionBtn");if(n){const r=n.dataset.id;P(),typeof window.openOrderModal=="function"&&setTimeout(()=>{window.openOrderModal(r)},350)}});function Ee(){if(!t.scrollToTopBtn)return;let e=!1,s=null,o=window.scrollY,n=null,r=0;const i=250,a=220,u=d=>{const c=Date.now();c-r<a||(r=c,t.scrollToTopBtn.classList.remove("dir-up","dir-down"),t.scrollToTopBtn.classList.add(d==="up"?"dir-up":"dir-down"),t.scrollToTopBtn.classList.add("tracks-burst"),clearTimeout(s),s=setTimeout(()=>t.scrollToTopBtn.classList.remove("tracks-burst"),i))},v=()=>{const d=window.scrollY>400;if(d&&!e){t.scrollToTopBtn.classList.add("show"),t.scrollToTopBtn.classList.add("dir-up"),e=!0;return}!d&&e&&(t.scrollToTopBtn.classList.remove("show","tracks-burst"),clearTimeout(s),e=!1)},L=()=>{n||(n=requestAnimationFrame(()=>{n=null,v();const d=window.scrollY,c=d-o;e&&Math.abs(c)>=12&&(c>0?u("up"):u("down")),o=d}))};window.addEventListener("scroll",L,{passive:!0}),v(),t.scrollToTopBtn.addEventListener("click",()=>{window.scrollTo({top:0,behavior:"smooth"})})}window.addEventListener("load",Ee);function F(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function we(e){let o=`<div class="review-stars" aria-label="Оцінка ${e} з 5">`;for(let n=1;n<=5;n++){let r;e>=n?r="star-filled":e>=n-.5?r="star-half":r="star-outline",o+=`
