  ...
  `}function ye(e){const s=de(e);s?(t.petModalOverlay.innerHTML=he(s),be()):m.failure(l.LOAD_FAIL)}function be(){t.petModalOverlay.classList.add("is-open"),document.body.classList.add("modal-open"),document.addEventListener("keydown",G)}function I(){t.petModalOverlay.classList.remove("is-open"),document.body.classList.remove("modal-open"),document.removeEventListener("keydown",G),setTimeout(()=>{t.petModalOverlay.innerHTML=""},300)}function G(e){e.key==="Escape"&&I()}document.addEventListener("click",e=>{const s=e.target,o=s.closest(".pet-more-info");if(o){const r=o.closest(".pet-list-item");r!=null&&r.id&&ye(r.id);return}if(s.closest(".pet-modal-close")||s===t.petModalOverlay){I();return}const n=s.closest("#petModalActionBtn");if(n){const r=n.dataset.id;I(),typeof window.openOrderModal=="function"&&setTimeout(()=>{window.openOrderModal(r)},350)}});function Ee(){if(!t.scrollToTopBtn)return;let e=!1,s=null,o=window.scrollY,n=null,r=0;const i=250,a=220,u=d=>{const c=Date.now();c-r<a||(r=c,t.scrollToTopBtn.classList.remove("dir-up","dir-down"),t.scrollToTopBtn.classList.add(d==="up"?"dir-up":"dir-down"),t.scrollToTopBtn.classList.add("tracks-burst"),clearTimeout(s),s=setTimeout(()=>t.scrollToTopBtn.classList.remove("tracks-burst"),i))},v=()=>{const d=window.scrollY>400;if(d&&!e){t.scrollToTopBtn.classList.add("show"),t.scrollToTopBtn.classList.add("dir-up"),e=!0;return}!d&&e&&(t.scrollToTopBtn.classList.remove("show","tracks-burst"),clearTimeout(s),e=!1)},L=()=>{n||(n=requestAnimationFrame(()=>{n=null,v();const d=window.scrollY,c=d-o;e&&Math.abs(c)>=12&&(c>0?u("up"):u("down")),o=d}))};window.addEventListener("scroll",L,{passive:!0}),v(),t.scrollToTopBtn.addEventListener("click",()=>{window.scrollTo({top:0,behavior:"smooth"})})}window.addEventListener("load",Ee);function F(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function we(e){let o=`<div class="review-stars" aria-label="Оцінка ${e} з 5">`;for(let n=1;n<=5;n++){let r;e>=n?r="star-filled":e>=n-.5?r="star-half":r="star-outline",o+=`
    ...
    <div class="dev-team-modal">
      ...
      <ul class="dev-modal-content-list">
        ...
        `}).join(""),Y=e=>{e.key==="Escape"&&X()},Be=()=>{t.devTeamModalOverlay.classList.add("is-open"),document.body.classList.add("modal-open"),document.addEventListener("keydown",Y)},X=()=>{t.devTeamModalOverlay.classList.remove("is-open"),document.body.classList.remove("modal-open"),document.removeEventListener("keydown",Y),setTimeout(()=>{t.devTeamModalOverlay.innerHTML=""},300)};document.addEventListener("click",e=>{const s=e.target;if(s.closest(".dev-team-modal-close")||s===t.devTeamModalOverlay){X();return}});document.addEventListener("DOMContentLoaded",()=>{const e=document.querySelector(".checkbox"),s=document.documentElement,o=localStorage.getItem("theme"),n=window.matchMedia("(prefers-color-scheme: dark)").matches;o==="dark"||!o&&n?(s.setAttribute("data-theme","dark"),e.checked=!1):(s.setAttribute("data-theme","light"),e.checked=!0),e.addEventListener("change",()=>{e.checked?(s.setAttribute("data-theme","light"),localStorage.setItem("theme","light")):(s.setAttribute("data-theme","dark"),localStorage.setItem("theme","dark"))})});
