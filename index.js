import{a as b,A as te,S as u,b as K,P as U,N as se,K as ne}from"./assets/vendor-N3sEl8X9.js";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const i of o)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function t(o){const i={};return o.integrity&&(i.integrity=o.integrity),o.referrerPolicy&&(i.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?i.credentials="include":o.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(o){if(o.ep)return;o.ep=!0;const i=t(o);fetch(o.href,i)}})();const oe="global-loader";let m=0;function v(e){return!(e!=null&&e.skipGlobalLoader)}function H(){return document.getElementById(oe)}function P(){const e=H();e&&(e.classList.remove("is-hidden"),document.body.style.overflow="hidden")}function L(){const e=H();e&&(m>0||(e.classList.add("is-hidden"),document.body.style.overflow=""))}document.addEventListener("DOMContentLoaded",()=>{P()});window.addEventListener("load",()=>{setTimeout(()=>{L()},600)});const ie=window.fetch;window.fetch=async(...e)=>{m++,P();try{return await ie(...e)}finally{m--,setTimeout(()=>{L()},200)}};b.interceptors.request.use(e=>(v(e)&&(m++,P()),e));b.interceptors.response.use(e=>(v(e.config)&&(m--,setTimeout(()=>{L()},200)),e),e=>(v(e.config)&&(m--,setTimeout(()=>{L()},200)),Promise.reject(e)));const re=b.create;b.create=function(...e){const s=re.apply(this,e);return s.interceptors.request.use(t=>(v(t)&&(m++,P()),t)),s.interceptors.response.use(t=>(v(t.config)&&(m--,setTimeout(()=>{L()},200)),t),t=>(v(t.config)&&(m--,setTimeout(()=>{L()},200)),Promise.reject(t))),s};new te("#faq-accordion",{duration:300,showMultiple:!1});const ae=document.querySelector(".mobile-menu"),Y=document.querySelector(".menu-btn-open"),G=document.querySelector(".menu-btn-close"),ce=document.querySelectorAll(".mob-menu-link, .mob-menu-button"),$=()=>ae.classList.toggle("is-open"),q=()=>document.body.classList.toggle("is-scroll-disabled"),le=()=>{$(),q()};Y.addEventListener("click",$);G.addEventListener("click",$);Y.addEventListener("click",q);G.addEventListener("click",q);ce.forEach(e=>{e.addEventListener("click",le)});const x=b.create({baseURL:"https://paw-hut.b.goit.study/api"}),de="/categories",ue="/animals",me="/orders";async function pe(){const{data:e}=await x.get(de);return e}async function fe(e=null,s=1,t=9){const n={page:s,limit:t};e&&(n.categoryId=e);const{data:o}=await x.get(ue,{params:n,skipGlobalLoader:!0});return o}const ge=async e=>{const{data:s}=await x.post(me,e);return s};document.addEventListener("DOMContentLoaded",()=>{const e=document.querySelector(".order-form"),s=document.querySelector(".order-overlay"),t=e==null?void 0:e.querySelector('button[type="submit"]');let n=null;window.openOrderModal=function(r){if(!r){console.warn("Спроба відкрити форму без ID тварини");return}n=r,s.classList.add("is-open"),document.body.classList.add("modal-open"),document.addEventListener("keydown",i)};function o(){s.classList.remove("is-open"),document.body.classList.remove("modal-open"),document.removeEventListener("keydown",i),setTimeout(()=>{n=null,e&&(e.reset(),e.classList.remove("was-validated"))},250)}function i(r){r.key==="Escape"&&o()}s.addEventListener("click",r=>{(r.target.closest(".close-btn")||r.target===s)&&o()}),e&&e.addEventListener("submit",async r=>{var S,c;if(r.preventDefault(),e.classList.add("was-validated"),!e.checkValidity())return;if(!n){u.fire({title:"Помилка",text:"Не вдалося визначити ID тварини.",icon:"error",confirmButtonColor:"#2e2f42"});return}const E=new FormData(e),l=Object.fromEntries(E.entries()),g={name:l.name.trim(),phone:l.phone.trim(),comment:l.comment?l.comment.trim():"Хочу стати другом",animalId:n};try{t&&(t.disabled=!0,t.textContent="Надсилаємо..."),await ge(g),await u.fire({title:"Заявку успішно надіслано!",text:"Ми зв’яжемося з вами найближчим часом.",icon:"success",confirmButtonColor:"#2e2f42"}),o()}catch(p){const ee=((c=(S=p.response)==null?void 0:S.data)==null?void 0:c.message)||"Помилка при відправці.";u.fire({title:"Помилка!",text:ee,icon:"error"})}finally{t&&(t.disabled=!1,t.textContent="Надіслати")}})});const y={PETS_END:"Це всі хвостики за цим фільтром 🐾",PETS_EMPTY:"Хвостиків у цій категорії ще немає. Спробуйте іншу.",PETS_LOAD_FAIL:"Не вдалося завантажити хвостиків. Спробуйте ще раз.",PETS_CATEGORY_LOAD_FAIL:"Не вдалося завантажити категорії хвостиків. Перезавантажте сайт та спробуйте ще раз.",NETWORK:"Немає з’єднання з інтернетом.",PET_DETAILS_FAIL:"Не вдалося завантажити дані хвостика. Спробуйте ще раз.",UNKNOWN_ERROR:"Щось пішло не так. Перезавантажте сайт та спробуйте ще раз."};function O(e,s){u.close(),u.fire({toast:!0,position:"top-end",icon:e,title:s,showConfirmButton:!1,timer:3e3,timerProgressBar:!0,background:"var(--color-mariner-lightest)",color:"var(--color-scheme-1-text)",width:"420px",padding:"18px 20px",customClass:{popup:"swal2-toast"},didOpen:t=>{t.style.borderRadius="16px",t.style.border="1px solid var(--color-scheme-1-border)",t.style.fontFamily="var(--font-family)",t.style.boxShadow="0 10px 30px var(--opacity-neutral-darkest-15)",t.style.lineHeight="1.4",t.style.fontSize="15px",t.addEventListener("mouseenter",u.stopTimer),t.addEventListener("mouseleave",u.resumeTimer)}})}const w={success(e){O("success",e)},failure(e){O("error",e)},warning(e){O("warning",e)},info(e){O("info",e)}},a=document.querySelector(".custom-cursor"),V=document.querySelector(".nav-logo"),X=document.querySelector(".footer__logo");document.addEventListener("mousemove",e=>{a.style.left=e.clientX+"px",a.style.top=e.clientY+"px"});V.addEventListener("mouseenter",()=>{a.classList.add("beating","small"),a.classList.remove("large"),a.style.transform="translate(-50%, -50%) scale(1)"});V.addEventListener("mouseleave",()=>{a.classList.remove("beating","small"),a.style.transform="translate(-50%, -50%) scale(0)"});X.addEventListener("mouseenter",()=>{a.classList.add("beating","large"),a.classList.remove("small"),a.style.transform="translate(-50%, -50%) scale(1)"});X.addEventListener("mouseleave",()=>{a.classList.remove("beating","large"),a.style.transform="translate(-50%, -50%) scale(0)"});const f=document.querySelector(".pet-list"),d=document.querySelector(".load-more-pets-btn"),h=document.querySelector(".load-more-pets-btn-wrapper");let T=1,M=null,k=!1;function I(){f.innerHTML="",T=1,M=null,d.classList.add("is-hidden"),h.classList.add("is-hidden")}function ve(){return f.querySelectorAll(".pet-list-item").length>0}function ye(e){h&&(e?h.classList.remove("is-hidden"):h.classList.add("is-hidden"))}const we=()=>{const e=window.innerWidth;return e>=768&&e<1440?8:9};function he(){return`
  ...
  `}function D(){const e=f.querySelector(".pet-list-loader");e&&e.remove()}function Le(e){return e.map(({_id:s,name:t,age:n,gender:o,image:i,species:r,categories:E,behavior:l})=>`
  ...
  `).join("")}async function C(e=null,s=!1){if(!k){s&&(T=1,M=e,f.innerHTML="",h&&h.classList.add("is-hidden")),f.insertAdjacentHTML("beforeend",he()),k=!0;try{const t=we(),{animals:n,totalItems:o}=await fe(M,T,t);if(!Array.isArray(n)||n.length===0){I(),w.failure(y.PETS_EMPTY);return}D(),f.insertAdjacentHTML("beforeend",Le(n));const i=Math.ceil(o/t);T>=i||n.length===0?d&&d.classList.add("is-hidden"):d&&d.classList.remove("is-hidden")}catch(t){if(!t.response){w.failure(y.NETWORK);return}w.failure(y.UNKNOWN_ERROR),D(),d&&d.classList.add("is-hidden")}finally{k=!1,ye(ve())}}}d&&d.addEventListener("click",async()=>{if(k)return;T+=1,await C(M);const e=f.querySelector(".pet-list-item");if(e){const{height:s}=e.getBoundingClientRect();window.scrollBy({top:s,behavior:"smooth"})}});const _=document.querySelector(".categories-list");pe().then(e=>{if(!Array.isArray(e)||e.length===0){I(),w.failure(y.PETS_CATEGORY_LOAD_FAIL);return}const s=e.map(({_id:t,name:n})=>`<li class="categories-list-item" data-category-id="${t}">${n}</li>`);_.innerHTML='<li class="categories-list-item active" data-category-id="">Всі</li>'+s.join(""),C()}).catch(e=>{if(I(),!e.response){w.failure(y.NETWORK);return}w.failure(y.UNKNOWN_ERROR)});_.addEventListener("click",e=>{const s=e.target;if(s.nodeName!=="LI"||s.classList.contains("active"))return;const t=_.querySelector(".active");t&&t.classList.remove("active"),s.classList.add("active");const n=s.dataset.categoryId||null;C(n,!0)});const A=document.querySelector(".pet-modal-overlay");let R=[];const be=b.create({baseURL:"https://paw-hut.b.goit.study/api"}),z={NETWORK:"Відсутній зв’язок з сервером. Перевірте інтернет.",EMPTY_DATA:"Інформацію про тварин не знайдено.",LOAD_FAIL:"Не вдалося завантажити деталі тварини."};async function Ee(){if(!(R.length>0))try{let e=1;const s=20;let t=1/0,n=[];for(;n.length<t;){const o=await be.get("/animals",{params:{page:e,limit:s}}),{animals:i,totalItems:r}=o.data;if(!Array.isArray(i)||e===1&&i.length===0)break;n.push(...i),t=r||n.length,e++}R=n}catch(e){e.response||u.fire({title:"Мережа",text:z.NETWORK,icon:"error"})}}function Te(e){const t={Dogs:"Собака",Cats:"Кіт",Rabbits:"Кролик",Birds:"Птах",Other:"Тварина"}[e.species]||e.species||"Тварина",n=e._id||e.id;return`
    <div class="pet-modal">
